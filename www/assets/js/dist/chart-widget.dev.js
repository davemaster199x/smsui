...
(function ($) {
  ...
  window.setInterval(function () {
    ...
    chartColumn.updateSeries([
      {
        data: [].concat(
          _toConsumableArray(chartColumn.w.config.series[0].data),
      ...
      chartLine.updateSeries([
        {
          data: [].concat(
            _toConsumableArray(chartLine.w.config.series[0].data),
            [[chartLine.w.globals.maxX + 300000, getRandom()]]
          ),
        },
        {
          data: [].concat(
            _toConsumableArray(chartLine.w.config.series[1].data),
            [[chartLine.w.globals.maxX + 300000, getRandom()]]
          ),
        },
      ]);
